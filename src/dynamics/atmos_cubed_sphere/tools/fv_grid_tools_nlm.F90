...
module fv_grid_tools_nlm_mod
  ...
  use fv_grid_utils_nlm_mod, only: project_sphere_v

  use fv_timing_nlm_mod,  only: timing_on, timing_off
  use fv_mp_nlm_mod,      only: ng, is_master, fill_corners, XDir, YDir
  use fv_mp_nlm_mod,      only: mp_gather, mp_bcst, mp_reduce_max, mp_stop
...
!
 ...
 enddo
      ...
      end module fv_grid_tools_nlm_mod
