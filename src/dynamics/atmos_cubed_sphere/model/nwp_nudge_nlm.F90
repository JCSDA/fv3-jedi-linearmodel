module nwp_nudge_nlm_mod

 use fv_arrays_nlm_mod,  only: REAL4, REAL8, FVPRC
 use fv_control_nlm_mod,    only: npx, npy
 use fv_grid_utils_nlm_mod, only: i_sst, j_sst, sst_ncep
 use fv_grid_utils_nlm_mod, only: vlon, vlat, sina_u, sina_v, da_min, great_circle_dist, ks, intp_great_circle
 use fv_grid_tools_nlm_mod, only: agrid, dx, dy, rdxc, rdyc, rarea, area
 use fv_diagnostics_nlm_mod,only: prt_maxmin, fv_time
 use tp_core_nlm_mod,       only: copy_corners
 use fv_mapz_nlm_mod,       only: mappm
 use fv_mp_nlm_mod,         only: is,js,ie,je, isd,jsd,ied,jed, gid, masterproc, domain, mp_reduce_sum
